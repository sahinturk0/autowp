<?php return array (
  ...
  'car-type/singleseater' => 'Tek Kişilik',
  'car-type-rp/singleseater' => 'Tek Kişilik',
  'page/36/ng-name' => 'Teknik Özellikleri',
  'catalogue/all-pictures-of' => 'Tüm Resimleri',
  'catalogue/sport-of' => 'Spor',
  'catalogue/related-with' => 'ile ilgili',
  'catalogue/other-pictures-of' => ''nın diğer resimleri',
  'page/34/ng-name' => 'Bütün Resimleri {item}',
  'page/138/ng-name' => '{brand} {vehicle_type} Kronolojik Sırayla',
  'page/14/ng-name' => '{brand} Kronolojik Sırayla',
  'page/208/ng-name' => '{brand} Motorlar',
  'page/37/ng-name' => '{brand} Konsept ve Prototipler',
  'page/40/ng-name' => '{brand} Karışık',
  'page/39/ng-name' => '{brand} Logolar',
  'page/15/ng-name' => 'Son resimleri {brand}',
  'perspective/chassis' => 'Şasiler',
  'brands/more-{count}-companies' => 'more {count, plural, one {{count} company} other {{count} companies}}',
  'perspective/mockup' => 'model',
